...
namespace Gamekit2D
{
    public class Damageable : MonoBehaviour, IDataPersister
    {
        ...
        public static int nextIndexDamageable = 0;
        public int indexDamageable = -66;
        ...
        {
            indexDamageable = nextIndexDamageable;
            nextIndexDamageable++;
        }
        ...
        public void AddingInSaveData()
        {
            if (gameObject.layer == 9)
            {
                DataScene.instance.AddEnemyIsDead(indexDamageable);
            }
            else if(gameObject.layer == 16)
            {
                DataScene.instance.AddDestructibleIsDestroy(indexDamageable);
            }
        }
    }
}
