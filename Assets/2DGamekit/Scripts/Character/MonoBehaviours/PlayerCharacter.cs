...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public bool cameraFocusOnSpriteOnly = false;
        ...
        public void JumpSpeedModifier(int value)
        {
            jumpSpeed += value;
        }

        public void UpdatePlayerCharacterStatistiqueOnEvolve(int index)
        {
            SaveManager.instance.dataSave.IndexEvolveEllen = index;
            ...
            switch (index)
            {
                case 0:
                    ...
                    dashWhileAirborne = false;
                    meleeAttackDashSpeed = 4;
                ...
                case 2:
                    ...
                    dashWhileAirborne = true;
                    meleeAttackDashSpeed = 6;
                    break;

                case 3:
                    maxSpeed = 6f;
                    groundAcceleration = 75;
                    groundDeceleration = 75;
                    jumpSpeed = 17.5f;

                    shotsPerSecond = .9f;

                    dashWhileAirborne = true;
                    meleeAttackDashSpeed = 8;
                    break;
