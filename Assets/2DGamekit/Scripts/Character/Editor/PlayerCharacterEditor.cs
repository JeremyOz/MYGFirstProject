...
namespace Gamekit2D
{
    ...
    {
        SerializedProperty m_CameraFocusOnSpriteOnlyProp;
        ...
        readonly GUIContent m_CameraFocusOnSpriteOnlyContent = new GUIContent("Camera Focus On Sprite Only");
        ...
        readonly GUIContent m_CasParticulierContent = new GUIContent("Cas Particulier");
        ...
        void OnEnable ()
        {
            m_CameraFocusOnSpriteOnlyProp = serializedObject.FindProperty("cameraFocusOnSpriteOnly");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            m_CasParticulierFoldout = EditorGUILayout.Foldout(m_CasParticulierFoldout, m_CasParticulierContent);

            if (m_CasParticulierFoldout)
            {
                EditorGUILayout.PropertyField(m_CameraFocusOnSpriteOnlyProp, m_CameraFocusOnSpriteOnlyContent);
            }
