...
namespace Gamekit2D
{
    ...
    public class SceneController : MonoBehaviour
    {
        ...
        public static void RestartZoneEdit(bool resetHealth = true)
        {
            ...
            Instance.StartCoroutine(Instance.Transition(Instance.m_CurrentZoneScene.name, true, SceneTransitionDestination.DestinationTag.A, TransitionPoint.TransitionType.DifferentZone));
        }
        ...
        {
            Instance.StartCoroutine(CallWithDelay(delay, RestartZoneEdit, resetHealth));
        }
